    ...
    <div class="py-4 w-full">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-2">
                ...
                <a href="{{ route('admin.posts.index', ['category' => Request()->category]) }}" class="px-4 py-2 bg-green-700 hover:bg-green-500 text-slate-100 rounded-md">Back</a>
                </div>
                <div class="flex flex-col">
                    <div class="space-y-8 divide-y divide-gray-200">
                        <form method="POST" action="{{ route('admin.posts.store', ['category' => Request()->category]) }}"
                            ...
                            <div class="sm:col-span-6">
                                ...
                                <div class="mt-1">
                                    <input type="file" id="thumbnail" name="thumbnail" class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                                </div>
                            ...
                            <div class="sm:col-span-6">
                                ...
                                <div class="mt-1">
                                    ...
                                    transition duration-150 ease-in-out sm:text-sm sm:leading-5" rows="5"></textarea>
                                </div>
